...
@Component({
  selector: 'app-invoicestdsgrid',

  templateUrl: './invoicestdsgrid.component.html',
  styleUrl: './invoicestdsgrid.component.css'
})
export class InvoicestdsgridComponent {
  tablegridviews: any;
  tablegridview!:any[];
  Invoicedata: any;
...
const name='Paymententry';
  ...
  Assignvalue(APE_id: any) {
    ...
    this.APIServies.getallpayment(this.BR_key).subscribe((value) => {
      ...
      this.router.navigate(['/Invoicetds'], {
        state: {
